...
describe('OpenAIService', () => {
  ...
  beforeEach(() => {
    openAIService = new OpenAIService(/* constructor arguments if any */);
  });
  ...
  it('should analyze content successfully', async () => {
    ...
    jest.spyOn(openAIService, 'analyze').mockResolvedValue('Expected result');
  ...
  it('should handle errors during analysis', async () => {
    ...
    jest.spyOn(openAIService, 'analyze').mockRejectedValue(new Error('Test error'));

    // Act & Assert: Verify that the method throws an error
    await expect(openAIService.analyze(content, template, style)).rejects.toThrow('Test error');
  });
